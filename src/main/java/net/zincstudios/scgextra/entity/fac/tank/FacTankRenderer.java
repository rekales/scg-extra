...
public class FacTankRenderer extends BaseEntityRenderer<FacTankEntity> {
    ...
    @Override
    public void render(FacTankEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        super.render(entity, entityYaw, partialTick, poseStack, bufferSource, packedLight);
        addExhaustSmoke(entity, entityYaw);
    }

    private void addExhaustSmoke(FacTankEntity entity, float yaw) {
