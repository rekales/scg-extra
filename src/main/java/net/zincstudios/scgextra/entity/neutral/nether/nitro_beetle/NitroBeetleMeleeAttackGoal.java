...
public class NitroBeetleMeleeAttackGoal extends Goal {
   ...
   protected final NitroBeetleEntity mob;
   ...
   public NitroBeetleMeleeAttackGoal(NitroBeetleEntity mob, double speedModifier, boolean followingTargetEvenIfNotSeen) {
      this.mob = mob;
