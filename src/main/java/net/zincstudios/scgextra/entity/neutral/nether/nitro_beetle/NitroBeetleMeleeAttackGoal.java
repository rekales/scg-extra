...
public class NitroBeetleMeleeAttackGoal  extends Goal {
   ...
   public NitroBeetleMeleeAttackGoal(PathfinderMob mob, double speedModifier, boolean followingTargetEvenIfNotSeen) {
      this.mob = mob;
      ...
      if (i - this.lastCanUseCheck < 20L) {
         ...
         if (livingentity == null) {
            ...
            if (this.path != null) {
               ...
               return this.getAttackReachSqr(livingentity) >= this.mob.distanceToSqr(livingentity.getX(), livingentity.getY()+1, livingentity.getZ());
            }
         }
      }
   }
