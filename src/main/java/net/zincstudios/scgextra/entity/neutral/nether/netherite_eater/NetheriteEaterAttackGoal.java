...
public class NetheriteEaterAttackGoal extends MeleeAttackGoal{

    private int ticksUntilNextAttack;
    private NetheriteEaterEntity entity;
    private int cooldown = 0;
    public NetheriteEaterAttackGoal(NetheriteEaterEntity mob, double speedModifier, boolean followingTargetEvenIfNotSeen) {
