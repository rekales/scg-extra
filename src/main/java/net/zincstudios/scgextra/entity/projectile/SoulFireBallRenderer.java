...
public class SoulFireBallRenderer extends EntityRenderer<SoulFireball> {
    ...
    private static final ResourceLocation TEXTURE_LOCATION = SCGExtra.asResource("textures/entity/projectile/soul_fire_charge.png");
    ...
    public void render(SoulFireball entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
     ...
     */
    public ResourceLocation getTextureLocation(SoulFireball entity) {
