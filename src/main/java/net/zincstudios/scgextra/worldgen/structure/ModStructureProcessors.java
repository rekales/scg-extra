...
import net.zincstudios.scgextra.worldgen.structure.processors.FACWarshipProcessor;
...
public class ModStructureProcessors {
    ...
    public static final RegistryObject<StructureProcessorType<FACWarshipProcessor>> WARSHIP_PROCESSOR = STRUCTURE_PROCESSOR_TYPES.register("warship_processor", ()->()->FACWarshipProcessor.CODEC);
