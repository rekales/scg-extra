...
public class ModStructureProcessors {
    ...
    public static final RegistryObject<StructureProcessorType<TrenchesStructureProcessor>> TRENCHES_PROCESSOR =
            STRUCTURE_PROCESSOR_TYPES.register("trenches_processor",
                    () -> () -> TrenchesStructureProcessor.CODEC);
